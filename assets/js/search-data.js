...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-how-can-we-trace-llm-outputs-back-to-reliable-sources-in-our-paper-attribution-citation-and-quotation-a-survey-of-evidence-based-text-generation-with-large-language-models-accepted-to-acl-2026-we-present-a-unified-overview-of-this-emerging-research-area-looking-forward-to-sharing-our-work-in-san-diego",
          title: 'How can we trace LLM outputs back to reliable sources? In our paper,...',
          description: "",
